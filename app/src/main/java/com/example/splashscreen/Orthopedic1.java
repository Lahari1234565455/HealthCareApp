...
public class Orthopedic1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_orthopedic1);
    }
    ...
    public void booknow(View view) {
        ...
        Intent intent = new Intent(this, BO1.class); // Replace with actual activity
        startActivity(intent);
    }
}
