...
public class Gynecologist2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gynecologist2);
    }
    ...
    public void booknow(View view) {
        ...
        Intent intent = new Intent(this, BG2.class); // Replace with actual activity
        startActivity(intent);
    }
}
