...
public class Sendmessage18 extends AppCompatActivity {
    EditText t0;
    Button send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendmessage18);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ContextCompat.checkSelfPermission(Sendmessage18.this, Manifest.permission.SEND_SMS)
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Sendmessage18.this,
    ...
    private void sendSMS() {
        ...
        if (!phoneNumber.isEmpty()) {
            try {
                ...
                Intent confirmIntent = new Intent(Sendmessage18.this, cde2.class);
