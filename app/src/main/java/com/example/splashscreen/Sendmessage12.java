...
public class Sendmessage12 extends AppCompatActivity {
    EditText t0;
    Button send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendmessage12);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ContextCompat.checkSelfPermission(Sendmessage12.this, Manifest.permission.SEND_SMS)
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Sendmessage12.this,
    ...
    private void sendSMS() {
        ...
        if (!phoneNumber.isEmpty()) {
            try {
                ...
                Intent confirmIntent = new Intent(Sendmessage12.this, CD12.class);
