...
public class Sendmessage27 extends AppCompatActivity {
    EditText t0;
    Button send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendmessage27);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ContextCompat.checkSelfPermission(Sendmessage27.this, Manifest.permission.SEND_SMS)
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Sendmessage27.this,
    ...
    private void sendSMS() {
        ...
        if (!phoneNumber.isEmpty()) {
            try {
                ...
                Intent confirmIntent = new Intent(Sendmessage27.this, EC2.class);
