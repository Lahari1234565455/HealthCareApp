...
public class Gynecologist3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gynecologist3);
    }
    ...
    public void booknow(View view) {
        ...
        Intent intent = new Intent(this, BG3.class); // Replace with actual activity
        startActivity(intent);
    }
}
