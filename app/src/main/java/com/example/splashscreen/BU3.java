...
public class BU3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bu3);

        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView dateDisplay = findViewById(R.id.date_display);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button datePickerButton = findViewById(R.id.date_picker_button);
    ...
    private void bookAppointment() {
        ...
        Intent intent = new Intent(this, Ortho3confirm.class);
