...
public class Sendmessage19 extends AppCompatActivity {
    EditText t0;
    Button send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendmessage19);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ContextCompat.checkSelfPermission(Sendmessage19.this, Manifest.permission.SEND_SMS)
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Sendmessage19.this,
    ...
    private void sendSMS() {
        ...
        if (!phoneNumber.isEmpty()) {
            try {
                ...
                Intent confirmIntent = new Intent(Sendmessage19.this, cde3.class);
