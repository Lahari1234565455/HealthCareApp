...
public class Sendmessage22 extends AppCompatActivity {
    EditText t0;
    Button send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendmessage22);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ContextCompat.checkSelfPermission(Sendmessage22.this, Manifest.permission.SEND_SMS)
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Sendmessage22.this,
    ...
    private void sendSMS() {
        ...
        if (!phoneNumber.isEmpty()) {
            try {
                ...
                Intent confirmIntent = new Intent(Sendmessage22.this, ac2.class);
